...
> human collaborators for you. (**NOTE**: The only exception to this rule is if you're a non-native English speaker, and you use AI to smooth out
> your messages, which is 100% okay by us. Just please let us know beforehand so we don't mistake your communication to be disrespectful!)
> 
> 5. AI-generated feature requests or bug reports are **not allowed**. If there's a new thing you want to see in the framework, or if there's an 
> issue with your game or the framework itself, *you* are the one who should address it. AI is allowed to find the bug itself, but you need to 
> be the one presenting it. This also includes feature requests for the same obvious reasons.

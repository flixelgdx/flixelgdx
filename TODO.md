...
- [ ] Fork [gdx-teavm](https://github.com/xpenatan/gdx-teavm) (with the name being `flx-teavm` to easily identify it's for FlixelGDX) and heavily optimize it to make Java games run buttery smooth
  - [ ] Add rich documentation so users know how to use it, since the docs for TeaVM is so buns :broken_heart:
  - [ ] Add extension to make the [gdx-miniaudio](https://github.com/rednblackgames/gdx-miniaudio) library work on the web to allow powerful audio control in games
